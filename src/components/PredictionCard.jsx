...
export default function PredictionCard({ game, onCompare }) {
  ...
  const risk = getRiskDetails(prediction.riskLevel);
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <span className="badge" style={{ 
            ...
            {isLive ? 'EN VIVO - ' + status.detail : isFinished ? 'FINAL' : status.detail}
          </span>
        </div>
